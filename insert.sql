...
INSERT INTO Multimedia(ID, ordering, genres, Title, IsOriginal,IsAdult, plot_outline)
SELECT titles.x1, titles.x2, t1.x9, titles.x3, titles.x8, t1.x5, t1.x3
FROM titles, t1
...
(select ID, ordering, Title, IsOriginal,IsAdult, plot_outline, genres, Anti_social_elements, soundtrack, websites from Multimedia1 ORDER BY ID, ordering);
...
SELECT titles.x1, titles.x2, titles.x3, titles.x5, ratings.x2
FROM titles, ratings, t1
WHERE titles.x1 = t1.x1 AND titles.x1 = ratings.x1 AND t1.x2 != 'tvSeries' AND t1.x2 != 'tvEpisode';
...
SELECT titles.x1, titles.x2, titles.x3, titles.x5, ratings.x2
FROM titles, t1, ratings
WHERE titles.x1 = t1.x1 AND ratings.x1 = t1.x1 AND t1.x2 = 'tvSeries';
...
CREATE TABLE temp1 (a1 TEXT, a2 INT, a3 TEXT, a4 TEXT, a5 NUMERIC(3,1));
INSERT INTO temp1(a1, a2, a3, a4, a5)
SELECT titles.x1, titles.x2, titles.x3, titles.x5, ratings.x2
FROM titles, ratings
WHERE titles.x1 = ratings.x1;

INSERT INTO Episodes(Episode_ID, ep_ordering, Episode_name, TV_series_ID, Season_Number, Episode_Number, lang, Rating)
SELECT temp1.a1, temp1.a2, temp1.a3, t4.x2, t4.x3, t4.x4,a4, temp1.a5
FROM temp1, t4
WHERE t4.x1 = temp1.a1;
...
INSERT INTO  mu_worked_by(Serial_no, ID, Crew_ID,Role_, Specific_Role)
SELECT Multimedia.Serial_no, t5.x1, t5.x3, t5.x4, t5.x5
FROM t5, Multimedia
WHERE Multimedia.ID = t5.x1 AND Multimedia.ordering = t5.x2;

-- populating ep_worked_by table
INSERT INTO ep_worked_by(Serial_no, Crew_ID, Episode_ID, TV_series_ID, Role_, Specific_Role)
SELECT Episodes.ESerial_no, t5.x3, t5.x1 ,t4.x2, t5.x4, t5.x5
FROM t5, t4, Episodes
WHERE Episodes.Episode_ID = t5.x1 AND Episodes.ep_ordering = t5.x2 AND t4.x1 = t5.x1;

-- populating Air_info table
INSERT INTO Air_info(Serial_no, Location_ID, runtime, Air_date)
SELECT Episodes.ESerial_no, Locality.Location_ID , t1.x8, t1.x6
